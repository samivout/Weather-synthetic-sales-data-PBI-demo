"""
Simple utility module for constructing a text representation of the project tree with line counts for code lines
and docstring lines.
"""
...
IGNORE_DIRS = [".git", "__pycache__", ".pytest_cache", "powerbi_project"]
IGNORE_EXTENSIONS = []
...
def print_dir_structure(path: Path, prefix: str = "", ignore_dirs: Iterable[str] = (),
    ...
    if stats is None:
        stats = {
            "synda": {"total": 0, "code": 0, "docstring": 0},
    ...
    for i, item in enumerate(items):
        ...
        if item.is_file() and item.suffix == ".py":
            ...
            label = "tests" if current_in_tests else "synda"
    ...
    if root_call:
        ...
        for category in ["synda", "tests", "total"]:
